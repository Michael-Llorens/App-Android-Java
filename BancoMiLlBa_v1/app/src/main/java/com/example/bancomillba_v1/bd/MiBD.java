...
import com.example.bancomillba_v1.dao.ClienteDAO;
import com.example.bancomillba_v1.dao.CuentaDAO;
import com.example.bancomillba_v1.dao.MovimientoDAO;
...
public class MiBD extends SQLiteOpenHelper {
    ...
    private void insercionDatos(SQLiteDatabase db){
        ...
        db.execSQL("INSERT INTO clientes (rowid, id, nif, nombre, apellidos, claveSeguridad, email) VALUES (null, null, '00000000G', 'Garfil', '-', '1234', '-');");
